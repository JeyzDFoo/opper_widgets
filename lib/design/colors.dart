...
class PlanningColors {
  static Color purpose = Colors.blue.withAlpha(100);
  static Color objective = Colors.green.withAlpha(120);
  static Color keyResult = Colors.purple.withAlpha(120);
  static Color milestone = Colors.orange.withAlpha(120);
  static Color delegate = Colors.red.withAlpha(120);
}
